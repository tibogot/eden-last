...
export default function HomeOverlappingCardSwiper() {
  ...
  return (
    <section
      className="bg-secondary text-primary flex w-full items-start gap-[2vw] overflow-hidden py-20"
      style={{ minHeight: "80vh" }}
    >
      <div className="flex w-1/2 shrink-0 flex-col items-start justify-start px-4 md:px-8">

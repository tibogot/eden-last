...
export default function MorphogenesisScroll({
  ...
  return (
    <>
      <section
        ref={heroRef}
        className="relative h-[175svh] w-full overflow-hidden text-[#fec81d]"
      >
        {/* Background Image */}
        ...
        {/* Header */}
        <div className="absolute flex h-svh w-full flex-col items-center justify-center gap-2 text-center">
          <h1 className="font-ivy-headline text-[clamp(4rem,7.5vw,10rem)] leading-[0.9] font-medium uppercase">
            {title}
          </h1>
          <p className="font-neue-haas w-3/4 text-lg font-normal">{subtitle}</p>
        </div>

        {/* WebGL Canvas */}
        <canvas
          ref={canvasRef}
          className="pointer-events-none absolute bottom-0 h-full w-full"
        />

        {/* Content */}
        <div className="absolute bottom-0 flex h-[125svh] w-full items-center justify-center text-center">
          <h2 className="font-ivy-headline hero-content w-3/4 text-[clamp(2.5rem,4.5vw,5rem)] leading-[0.9] font-medium text-[#0f0f0f] uppercase">
            {content}
          </h2>
        </div>
      </section>
      ...
      {/* About Section */}
      {aboutText && (
        <section className="relative flex h-svh w-full items-center justify-center bg-[#0f0f0f] text-[#ebf5df]">
          <p className="font-neue-haas w-[40%] text-center text-lg font-normal max-md:w-[calc(100%-4rem)]">
            {aboutText}
          </p>
        </section>
      )}

...
export default function HorizontalScrollSection({
  ...
  return (
    <div ref={containerRef} className="relative w-full bg-secondary text-primary">
      ...
      <section className="horizontal-scroll relative h-svh w-full overflow-hidden">
        <div className="horizontal-scroll-wrapper absolute top-0 left-0 flex h-svh translate-x-0 will-change-transform">
          ...
          {slides.map((slide, index) => (
            <div
              key={index}
              className="horizontal-slide flex h-full w-screen min-w-screen flex-col-reverse gap-8 bg-primary p-16 text-secondary lg:flex-row lg:p-8"
            >
      ...
      <section className="outro relative flex h-svh w-full items-center justify-center bg-primary p-8 text-center text-secondary">
        <h1 className="font-ivy-headline mx-auto w-full text-4xl leading-tight font-medium tracking-tight lg:w-3/4 lg:text-[4rem]">
          {outroText}
        </h1>
      </section>
